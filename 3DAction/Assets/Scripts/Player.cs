...
public class Player : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // danceKekyDown = Input.GetButtonDown("")
    ...
    void Move()
    {
        ...
        transform.LookAt(transform.position + moveVec);  // 가는 방향으로 시선 로테이션.
    }
    ...
    void Attack()
    {
        ...
        if(attackKeyDown && isAttackReady && !isDodge &&!isSwapWeapon)
        {
            ...
            anim.SetTrigger(equipWeapon.type == Weapon.OffenseDistance.Short ? "doAttack" : "doShot");
        }
    }
